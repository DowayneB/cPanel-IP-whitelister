...
if(isset($_POST['ip_add'])){
    ...
    if($valid){
        ...
        //check if this IP is in the removed IP's list, and remove it.
        ...
        echo "<div class='alert alert-dismissible alert-info info'>".$ip_addr." has been added to the whitelist<br><br></div>";
    }else{
...
if(isset($_POST['ip_remove'])){
    ...
    if($valid){
        ...
        echo "<div class='alert alert-dismissible alert-info info'>".$_POST['ip_remove']." has been removed from the whitelist<br><br></div>";
    }else{
        //log injection attempt if user tries to manipulate IP address to remove
        echo "<div class='alert alert-dismissible alert-danger'>Injection attempt has been logged with Server Administrator.</div>";
            ...
            <? foreach ($ips as $ip){?>
                <?if(strlen($ip) < 7){
                    ...
                    <tr class="tableactive">
                        ...
                        <td>
                            <form action="?" method="post">
                                <button value=<? echo "\"".$ip."\";" ?> name="ip_remove" type="submit" class="btn btn-primary">Remove</button>
                            </form>
                        </td>
                    </tr>
                <?}}?>
